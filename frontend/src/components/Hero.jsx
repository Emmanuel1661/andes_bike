...
export default function Hero() {
  return (
    <section
      className="relative w-full h-[60vh] sm:h-[70vh] md:h-[90vh] flex justify-center items-center rounded-2xl shadow-xl overflow-hidden"
      style={{
        backgroundImage: `url(${bicicletaFondo})`,
        backgroundSize: 'cover',
        backgroundPosition: 'center center',
        backgroundRepeat: 'no-repeat',
        backgroundAttachment: 'scroll', // Cambiar a 'fixed' si quieres parallax
      }}
    >
